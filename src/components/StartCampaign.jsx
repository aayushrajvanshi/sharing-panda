                    ...
                    <div className="uk-child-width-1-3@m uk-light uk-grid-match" data-uk-grid data-uk-scrollspy="cls: uk-animation-fade; target: > div > .uk-card; delay: 200; repeat: true">
                        <div>
                            <div className="uk-card uk-card-default uk-card-body uk-height-large uk-padding-remove">
                                <div className="uk-background-cover uk-background-secondary uk-height-large" style={{ 'backgroundImage': 'url(' + img1 + ')' }}>
                        ...
                        <div>
                            <div className="uk-card uk-card-default uk-card-body uk-height-large uk-padding-remove">
                                <div className="uk-background-cover uk-background-secondary uk-height-large" style={{ 'backgroundImage': 'url(' + img2 + ')' }}>
                                    <span data-uk-icon="icon: users; ratio:8" style={{ 'color': 'white' }}></span>
                        ...
                        <div>
                            <div className="uk-card uk-card-default uk-card-body uk-height-large uk-padding-remove">
                                <div className="uk-background-cover uk-background-secondary uk-height-large" style={{ 'backgroundImage': 'url(' + img3 + ')' }}>
                                    <span data-uk-icon="icon: users; ratio:8" style={{ 'color': 'white' }}></span>
